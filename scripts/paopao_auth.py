#!/usr/bin/env python3
"""Access and service client for paopao."""
...
WORKFLOW_PROTOCOL_VERSION = "".join(["direct-pptx-", "pack", "ets-v1"])
...
DEFAULT_TIMEOUT = 20
REQUEST_RETRIES = 3
UPDATE_INSTRUCTION_ZH = "请先运行：python3 scripts/paopao_run.py update，然后重新开始生成 PPT；如果仍然失败，请重新下载安装最新版 paopao 插件。"
UPDATE_INSTRUCTION_EN = "Please run: python3 scripts/paopao_run.py update, then restart PPT generation. If it still fails, reinstall the latest paopao plugin."
